function onOpen() {
  ...
  ui.createMenu('Google Fit')
      ...
      .addItem('Get Sleepdata for Yesterday', 'getSleepData')
      .addItem('Get Sleepdata for past 60 days', 'getSleepHistory')
      .addItem('Reset Settings', 'clearProps')
      .addItem('Add Calendar Events', 'addCalendarEvents')
      .addToUi();
}
...
function addCalendarEvents() {
  ...
  const fitnessCalID = "k9pf2p0r8ppudr643nn3dfifco@group.calendar.google.com";
  updateSongsDataScripts.generateFitnessEvents(fitnessCalID,2,5);
}  
